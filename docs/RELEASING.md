...
5. Confirm no private artifacts, local paths, or non-noreply identities appear
   in any reachable Git ref.
...
and publishes the assets with generated release notes.
...
`gh attestation verify`, and inspect the UF2 family/address before announcing
the release.
